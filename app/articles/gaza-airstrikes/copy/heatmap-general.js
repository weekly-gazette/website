...
export default function HeatMapGeneral() {
    return (
        <div className="flex flex-col space-y-10 text-lg p-10">
            <div>
                ...
                <ul className="list-disc pl-5 space-y-2">
                    ...
                    <li>Targeting civilian infrastructure to increase “civil pressure” on Hamas</li>
                    <li>Killing Hamas or Islamic Jihad members by targeting their family homes</li>
                    <li>Projecting power to Israeli citizens to raise support</li>
                </ul>
                <br/>
                On the heatmap, you can see which areas have the highest frequencies of bombings, which include central
                cities like Jabalia, Gaza City, and Khan Younis. The IDF has killed high-ranking Hamas members in these
                ...
                resources. According to a report by Forensic Architecture, Israel repeatedly struck areas that had
                likely already been destroyed. Land used for agriculture has also been destroyed en masse. As of April
                2025, over 80% of farmland in Gaza had been damaged or rendered unusable by a combination of airstrikes,
                bulldozing, and other methods. In a territory almost entirely sealed off from the rest of the world, the
                consequences of destroying even small amounts of farmland can be deadly for civilians.
                <br/><br/>
                Lastly, airstrikes have been used to bolster support among Israelis. According to Haaretz, the Israeli
                military used airstrikes in tandem with social media in 2021 to garner Israeli support for the war. IDF
                soldiers created fake accounts on Instagram, TikTok, and Facebook, posting images and videos of
                airstrikes to demonstrate the strength of the Israeli military. In summary, airstrikes allow the IDF to
                minimize its human losses whilst advancing its strategic aims and maximizing the damage inflicted on the
                Gaza Strip.
            </div>
            <div>
                <Text className="text-2xl font-bold pb-3">How does the IDF choose where to strike?</Text>
                ...
                the Gaza Strip into over 600 cells, each of which is updated hourly with population density data
                collated from aerial photography. Despite its existence, a report from Forensic Architecture stated that
                directly after Oct. 7th, Israel consistently targeted areas when more civilians were expected in the
                area. This pattern has continued — as shown in the map above, Israel has also bombed designated safe
                zones repeatedly.
            </div>
            <div>
            ...
            <div>
                ...
                Palestinian civilians in the crossfire.
                <br/><br/>
                However, even assuming that Hamas uses civilian buildings and human shields on a large scale, this
                strategy is not necessarily effective given that the IDF is willing to bomb civilians disproportionately
                in order to achieve its military objectives. According to the +972 Magazine, there are cases where the
                IDF has approved the killing of almost a hundred civilians in order to eliminate one Hamas military
                commander.
            </div>
            <div>
