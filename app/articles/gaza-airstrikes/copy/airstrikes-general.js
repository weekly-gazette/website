...
export default function AirstrikesGeneral() {
    const events = [
        ...
        { date: '10-28-2023', label: "By this point, almost 4 in 10 Palestinians who were killed were in southern Gaza, where residents of northern Gaza were told to flee." },
